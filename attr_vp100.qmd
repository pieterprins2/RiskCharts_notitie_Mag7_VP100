---
title: "Attributie Individuele Aandelen"
format: 
  html:
...
Hoeveel individuele aandelen zijn er nodig voor een “goed gespreide portefeuille”? Het antwoord is enkele tientallen. Meer dan dat voegt weinig extra spreiding toe. Meer spreiding uit zich in een lagere volatiliteit (standaarddeviatie).
...
```
De volatiliteit is ongeveer hetzelfde als die van de index, maar de tracking error is desondanks hoog te noemen.

### Verklaring van het verschil tussen de portefeuille en de benchmark

#### Allocatie en selectie
...
#### 1) uit sectorallocatie en aandelenselectie
...
#### 2) uit aandelenselectie per individueel aandeel
...
Voor de *Andere aandelen* (niet-MAg7 aandelen waarvoor gegevens beschikbaar zijn) is de eerste periode een mix van positieve en negatieve bijdragen. Per saldo licht positief. In sommige gevallen (bijv. UNH en PFE) draait het positieve resultaat in de tweede periode naar sterk negatief. In IT is de bijdrage in alle gevallen negatief. De tweede periode is sterk negatief. Per saldo (zie de tab "Totaal") is het effect van de *Andere aandelen* sterk negatief.

Er zijn aandelen bij die niet in portefeuille zijn geweest, maar waarvan wel koersen zijn gedownload. Dit betreft LLY in Health Care en NFLX in Communication Services. Een paar aandelen zijn niet meer beschikbaar: DSM (positieve bijdrage) en RDSA.
...
### Meer individuele aandelen noodzakelijk?
...
Je ziet de tracking error pas bij enkele honderden aandelen substantieel dalen. Deze research is gemotiveerd door de Mag7 dicussie, maar de Mag7 hebben per saldo dus geen performance nadeel opgeleverd in de portefeuille.
...
- Als
  ...
  - je rekening wilt houden met (nog) een "Mag7 scenario",
  - de impact van een individuele aandelenkeuze op de portefeuille (geluk resp. pech) beperkt moet blijven,
- Dan
  - dan moeten er meer individuele aandelen en/of trackers opgenomen worden of
  - moet een Stop loss ingebouwd worden om de impact van individuele aandelen te beperken.
